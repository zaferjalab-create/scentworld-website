...
const products = [
  ...
  { name: 'Fresh Blossom Oil', slug: 'fresh-blossom', category: 'oils', short_desc: 'Light floral blend with notes of spring blossoms and green leaves.', price: 49.00, coverage: null, sort_order: 10, image_url: '/images/products/SW101-430x430-1.webp' },
  { name: 'White Tea Oil', slug: 'white-tea', category: 'oils', short_desc: 'Clean, calming white tea fragrance perfect for spas and wellness spaces.', price: 49.00, coverage: null, sort_order: 11, image_url: '/images/products/SW102-430x430-1.webp' },
  { name: 'Oud Oil', slug: 'oud', category: 'oils', short_desc: 'Rich, warm oud blend — a signature Middle Eastern luxury fragrance.', price: 59.00, coverage: null, sort_order: 12, image_url: '/images/products/SW103-430x430-1.webp' },
  { name: 'Vienna Oil', slug: 'vienna', category: 'oils', short_desc: 'Sophisticated European-inspired blend with warm amber undertones.', price: 49.00, coverage: null, sort_order: 13, image_url: '/images/products/SW104-430x430-1.webp' },
  { name: 'Spark Honey Oil', slug: 'spark-honey', category: 'oils', short_desc: 'Sweet and vibrant honey-citrus blend for energizing spaces.', price: 49.00, coverage: null, sort_order: 14, image_url: '/images/products/SW106-430x430-1.webp' },
...
const insert = db.prepare(`
  INSERT OR IGNORE INTO products (name, slug, category, short_desc, price, coverage, sort_order, featured, image_url)
  VALUES (@name, @slug, @category, @short_desc, @price, @coverage, @sort_order, @featured, @image_url)
`);
...
console.log(`✅ ${count} products seeded, ${updatedImages} image_url defaults filled`);
